...
//Disminuir múltiplos de 3 Usando un bucle, escribe un código que haga que console.log imprima todos los valores 
...
//Imprime la secuencia Usando un bucle, escribe un código que haga que console.log imprima los valores 
//en esta secuencia  4, 2.5, 1, -0.5, -2, -3.5.
var i = 5.5;
while(i > -3.5){
    i = i - 1.5;
    console.log(i);
...
//console.log de como resultado  1 * 2 * 3 * ... * 10 * 11 * 12. Deberíamos obtener  479001600 al final.
var product = 1;
for(var i = 1; i<=12; i++){
